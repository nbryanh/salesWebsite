...
$sql = "SELECT * FROM Items  WHERE  (ItemID LIKE '%$query%') OR (ItemName LIKE '%$query%') OR (Discription LIKE '%$query%') OR (Price LIKE '%$query%') OR (ItemID LIKE '%$query2%') OR (ItemName LIKE '%$query2%') OR (Discription LIKE '%$query2%') OR (Price LIKE '%$query2%')";
